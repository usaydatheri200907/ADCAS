    ...
    <div>
      <div className="pt-16">
        <div className="bg-blue">
          <div className="bg-gray-800 w-full fixed top-16 left-0 right-0">
                  ...
                  <div className="h-full flex-col justify-between px-4 flex">
                    <div className="space-y-4">
                      <div className="bg-top bg-cover space-y-1">
                        <a
                          href="#"
                          className="font-medium text-sm items-left rounded-lg text-gray-900 px-4 py-2.5 flex transition-all duration-200 hover:bg-gray-200 group cursor-pointer"
                        >
                          <span className="justify-left items-left flex">
                            <span className="justify-left items-left flex">
                              <span className="justify-left items-left flex">
                                <span className="items-left justify-left flex">
                                  <svg
                        ...
                        <a
                          href="#"
                          className="font-medium text-sm items-left rounded-lg text-gray-900 px-4 py-2.5 block
                        ...
                        >
                          <span className="justify-left items-left fixed">
                            <span className="justify-left items-left fixed">
                              <span className="justify-left items-left fixed">
                                <span className="items-left justify-left fixed">
                                  <svg
                                    className="mr-4"
                                    width="24"
                                    height="24"
