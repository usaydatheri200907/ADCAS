          ...
          <div className="relative flex h-16 items-center justify-between">
            <div className="relative inset-y-0 left-0 flex items-center sm:hidden">
              <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                {open ? (
                  <XMarkIcon className="relative h-6 w-6" aria-hidden="true" />
                ) : (
                  <Bars3Icon className="relative h-6 w-6" aria-hidden="true" />
                )}
              </Disclosure.Button>
            </div>
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start sm:mx-10">
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? 'bg-cyan-900 text-white' : 'text-gray-300 hover:bg-cyan-700 hover:text-white',
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              {/* Profile dropdown */}
              <Menu as="div" className="relative mx-10">
                  <div>
